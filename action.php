...
if(!empty($_POST['action']) && ($_POST['action'])=='Truck'){	
	$inventory->getProductName();
}

if(!empty($_POST['action']) && ($_POST['action'])=='getProductWeight'){
	$inventory->getProductWeight();
}
if(!empty($_POST['id']) && ($_POST['action'])=='listCheckout'){
	$inventory->checkoutOrder();
}
// if(!empty($_POST['action']) && ($_POST['action'])=='getSI'){
// 	$inventory->checkoutOrder();
// }
if(!empty($_POST['pay_btn_action']) && $_POST['pay_btn_action'] == 'payOrder'){
	$inventory->payOrder();
}

if(!empty($_POST['CustomerID']) && $_POST['action'] == 'getCustomerBal'){
	$inventory->getCustomerBal();
}
if(!empty($_POST['action']) && $_POST['action'] == 'getPrice'){
	$inventory->getPrice();
}